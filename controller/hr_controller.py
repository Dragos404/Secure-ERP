...
def update_employee():
    ...
    update_employee_data = view.get_inputs([hr.HEADERS[hr.NAME_INDEX], hr.HEADERS[hr.DATE_OF_BIRTH_INDEX], hr.HEADERS[hr.DEPARTMENT_INDEX], hr.HEADERS[hr.CLEARANCE_INDEX]])
    hr.update_employee(updated_employee_id, update_employee_data)
...
def get_average_age():
    hr.get_employee_average_age()
    view.print_message(f"The average age is: {hr.get_employee_average_age()} years.")
...
def count_employees_with_clearance():
    ...
    view.print_message(f"There are {hr.count_employees_with_clearance(celearance_level)} employees with that minimum clearance level!")
